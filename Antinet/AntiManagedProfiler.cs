    ...
    public static class AntiManagedProfiler {
        ...
        class ProfilerDetectorCLR40 : IProfilerDetector {
            ...
            unsafe static void FixTimeOutOption(IntPtr timeOutOptionAddr) {
                ...
                VirtualProtect(timeOutOptionAddr, (int)ConfigDWORDInfo_defValue + 4, PAGE_EXECUTE_READWRITE,
                    out oldProtect);
                ...
                VirtualProtect(nameAddr, ProfAPIMaxWaitForTriggerMs_name.Length * 2, PAGE_EXECUTE_READWRITE,
                    out oldProtect);
            ...
            static SafeFileHandle CreatePipeFileHandle() {
                return CreateFile(GetPipeName(), GENERIC_READ | GENERIC_WRITE, 0, IntPtr.Zero, OPEN_EXISTING,
